CREATE OR REPLACE VIEW customer_segmentation AS -- Power BI visualization
...
segement_values AS (
    SELECT
        ...
        c.total_ltv,
        CASE
            WHEN c.total_ltv < percentile_25th THEN 'Low-Value'
...
SELECT
    ...
    100 * SUM(total_ltv) / (SELECT SUM(total_ltv) FROM segement_values) AS ltv_percentage,
